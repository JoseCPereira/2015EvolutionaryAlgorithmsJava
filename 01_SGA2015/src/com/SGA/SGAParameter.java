...
import com.SGA.SGA;
import com.SGA.SGASolver;


public class SGAParameter{
	...
	private static final String optionNames[] =     
		{"nRuns",
		 ...
		 "pCrossover", "nCrossover", "pSwap", "pMutation", 
	...
	throws NumberFormatException{
		...
		if(optionName.equals("nRuns")){
			SGA.nRuns = Integer.parseInt(optionValue);
			if(SGA.nRuns <= 0)
		...
		if(optionName.equals("N")){
			SGASolver.N = Integer.parseInt(optionValue);
			if(SGASolver.N <= 0)
		...
		if(optionName.equals("nCrossover")){
			...
			System.out.println(nCrossover);
			if(nCrossover < 0 || nCrossover > stringSize-1)
				exitError("Line" + nLine + " --> Number of cross points must be an integer BETWEEN '0' and 'n-1'.");
			return; // Option validated!!
		}
	...
	public static IReplacement initializeReplacement(){
		switch(replacementType){
			case 1: return new RestrictedReplacement(windowSize, SGASolver.N);
